...
def callback():
    ...
    if user_message == "เมนู":
        ...
        "2️⃣ พิมพ์ 'วิธีใช้' ดูคำแนะนำ\n"
        "3️⃣ พิมพ์ 'เกี่ยวกับระบบ' ดูข้อมูลโปรเจค")

    elif user_message == "วิธีใช้":
        reply_text(reply_token,
        "📸 วิธีใช้งาน\n\n"
        "1. พิมพ์ 'วิเคราะห์'\n"
        "2. ส่งภาพมังคุด 1 ลูก\n"
        "3. รอผลการวิเคราะห์\n\n"
        "⚠️ แนะนำถ่ายพื้นหลังเรียบ แสงสว่างเพียงพอ")

    elif user_message == "เกี่ยวกับระบบ":
        reply_text(reply_token,
        "🤖 Mangosteen AI Bot\n"
        "ระบบวิเคราะห์รอยช้ำมังคุด\n"
        "พัฒนาโดยนักเรียนมัธยม\n"
        "ใช้ Image Processing ด้วย OpenCV")
        ...
        reply_text(reply_token, "ไม่เข้าใจคำสั่ง 🤔\nพิมพ์ 'เมนู' เพื่อดูคำสั่งทั้งหมด")
